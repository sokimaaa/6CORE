...
class GetProductsServiceTest {
    ...
    void getProductsByIds_fullProductsIds_valiedFluxProductV01() {
        ...
        ProductV01 product1 = ImmutableProductV01Impl.builder()
                .productId("1")
                .name("Product 1")
                ...
                .category("Category 1")
                .build();
        ProductV01 product2 = ImmutableProductV01Impl.builder()
                .productId("2")
                .name("Product 2")
                ...
                .category("Category 2")
                .build();
        when(getProductsPort.getProductsByIds(productIds))
