...
public interface OrderMapper {
  ...
  default Iterable<? extends OrderItemV01> mapOrderItemRequests(Set<OrderItemRequest> orderItemRequests) {
    List<OrderItemV01> orderItems = new ArrayList<>();
    for (OrderItemRequest itemRequest : orderItemRequests) {
      ImmutableOrderItemV01Impl item = ImmutableOrderItemV01Impl.builder()
