...
public class OrderCreateServiceTest {
    @Mock
    private OrderDuplicateStrategy<OrderRequest> orderIdDuplicateStrategy;

    @Mock
    private OrderDuplicateStrategy<OrderRequest> userIdDuplicateStrategy;

    @Mock
    private OrderDuplicateContext<OrderRequest> duplicateContext;

    @Mock
    private OrderCorrectnessStrategy<OrderRequest> orderTotalCorrect;

    @Mock
    private OrderCorrectnessStrategy<OrderRequest> orderItemsCorrect;

    @Mock
    private OrderCorrectnessContext<OrderRequest> correctnessContext;
    ...
    void setUp() {
        ...
        orderCreateService = new OrderCreateService(orderIdDuplicateStrategy, userIdDuplicateStrategy,
                duplicateContext, orderTotalCorrect, orderItemsCorrect, correctnessContext,
    ...
    public void testCreateOrderDuplicate() {
        ...
        OrderRequest request = new OrderRequest("order123",
                "pending",
